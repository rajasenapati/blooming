...
function setupPostProcessing() {
  ...
  //add a DotScreenPass pass. this adds a very cool monochromatic effect of dots replacing a surface.
  //change the scale from 0.3 to 1 to 3 to get cool patterns
  // let center = new THREE.Vector2( 0.1, 0.9 ),
  // let angle = Math.PI/4,
  // let scale = 0.3
  const pass = new THREE.DotScreenPass(undefined, undefined, 0.3);
